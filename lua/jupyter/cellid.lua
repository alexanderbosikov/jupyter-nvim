...
-- **регенерирует все id** при обратной конвертации md → ipynb. Проверено на Sandbox.ipynb:
-- из 65 id не совпал ни один. То есть для персистентности он бесполезен.
--
...
-- Комментарием в теле его держать нельзя: в `%%sql`-ячейке `# ...` — не комментарий для
-- Redshift, а часть запроса, и он бы его сломал.
